    ...
    return (
      <div className={styles.sidebar}>
        <div className={styles.header}>
          ...
          <Button iconName="code" className={classNames(styles.headerButton, Classes.MINIMAL)} />
          <Button iconName="menu-closed" className={classNames(styles.headerButton, Classes.MINIMAL)} />
        </div>
...
export default function buildPropertiesEditor(id) {
