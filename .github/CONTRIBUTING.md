# Contributing to JiggleMap

Love JiggleMap and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/Touched/jigglemap/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/jigglemap.git
   # Navigate to the newly cloned directory
   cd jigglemap
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/Touched/jigglemap.git
   ```
...
owners to license your work under the terms of the [MIT License](https://github.com/Touched/jigglemap/blob/master/LICENSE.md).
